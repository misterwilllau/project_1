            ...
            <section id="contact" class="contact mt-5">
                <div class="container" data-aos="fade-up">
                    <div class="section-title">
                        ...
                        <p>Manage your property in easier way</p>
                    </div>
                    <div class="row mt-5">
                        <div class="col-lg-12 mt-12 mt-lg-0">
                            <form action="landing_page_backend/landlord_login_process.php" method="post" class="php-email-form">
                                ...
                                <div class="text-center"><input type="submit" name="landlord_login_submit" value="Login"></div>
                            </form>
                        </div>
                    </div>
                </div>
